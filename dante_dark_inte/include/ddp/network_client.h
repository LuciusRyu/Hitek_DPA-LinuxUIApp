...
#include "packet.h"
#include "proto/network_structures.h"
...
/**
* Reads a DNS domain name data field from a DDP network basic response message. N.B. This function should only be called after calling the ddp_read_network_basic_response_header function @see ddp_read_network_basic_response_header
* @param message_info [in] Pointer to a structure which has information about the DDP packet buffer, use the out_message_info parameter after calling the ddp_read_network_basic_response_header function
* @param dns_domain_idx [in] Index into the collection of DNS domain names, values range from 0 to number of dns domains - 1
* @param out_dns_domain [out optional] Pointer to a pointer to the null terminated domain name string
* @return AUD_SUCCESS if the dns domain name data field for the DDP network basic response message was successfully read, else a non AUD_SUCCESS value is returned
*/
aud_error_t
...
* @param dns_domain_name [in optional] Pointer to a dns domain name string that needs to be applied on the device, use NULL when querying the current DNS domain name
...
* @param dns_domain_name [in optional] Pointer to a dns_domain name string that needs to be applied on the device, use NULL when querying the current DNS domain name
* @return AUD_SUCCESS if the DDP network config request message was successfully created, else a non AUD_SUCCESS value is returned
*/
aud_error_t
...
* @param out_dns_domain_name [out optional] Pointer to a pointer to the null terminated DNS domain name string of the device 
