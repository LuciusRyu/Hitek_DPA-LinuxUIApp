...
#include "packet.h"
#include "proto/device_structures.h"
...
struct ddp_upgrade_xmodem
{
	...
	union
	{
		...
		} spi[DDP_XMODEM_SPI_NUM_DEVS];		/*!< Parameters for SPI mode */
...
* @param out_model_id [out optional] Pointer to the pointer to the 8-byte hexadecimal format Dante model ID @see dante_id64_t of the device
* @param out_model_id_string [out optional] Pointer to the pointer to the null terminated Dante model ID string of the device
...
* @param out_model_id_string [out optional] Pointer to the pointer to the null terminated model name string of the device
...
* @param out_dns_domain_string [out optional] Pointer to a pointer to a null terminated network domain name string.
* @deprecated Use \ref ddp_read_network_basic_response_dns_domain to retrieve the DNS domain name string instead
...
(
	...
	const char** out_dns_domain_string,
...
* @return AUD_SUCCESS if the DDP device AES67 command request message was successfully created, else a non AUD_SUCCESS value is returned
...
* @return AUD_SUCCESS if the DDP device AES67 response message was successfully read, else a non AUD_SUCCESS value is returned
* @note Only supported on the Brooklyn-II, Broadway and UltimoX platforms
*/
aud_error_t
...
* @param out_dante_domain_name [out optional] Pointer to the pointer to the name of the Dante domain the device is currently enrolled. If the device is not enrolled "unmanaged" is returned
* @param out_dante_domain_uuid [out optional] Pointer to the pointer to the UUID of the Dante domain the device is currently enrolled. If the device is not enrolled NULL is returned
* @return AUD_SUCCESS if the DDP device lock unlock response message was successfully read, else a non AUD_SUCCESS value is returned
*/
aud_error_t
...
(
	...
	char ** out_dante_domain_name,
	ddp_dante_domain_uuid_t ** out_dante_domain_uuid
);
...
/**
* Creates a DDP device config revision number query.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param request_id [in] A non-zero sequence number which is populated in this message
* @return AUD_SUCCESS if the DDP device config revision number query message was successfully created, else a non AUD_SUCCESS value is returned
*/
aud_error_t
...
/**
* Reads and validates device_config_revision_number response message from the Ultimo device.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param offset [in] Starting point in the packet buffer to read this message
* @param rev_num [in] Pointer to revision number
* @return AUD_SUCCESS if the DDP device config revision message was successfully read, else a non AUD_SUCCESS value is returned
*/
aud_error_t 
ddp_read_device_config_rev_num_response
(
	const ddp_packet_read_info_t * packet_info,
	uint16_t offset,
	uint32_t *rev_num
...
/**
* Creates a DDP device config read request message. 
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param request_id [in] A non-zero sequence number which is populated in this message
* @return AUD_SUCCESS if the DDP device config read request message was successfully created, else a non AUD_SUCCESS value is returned
*/
aud_error_t 
...
/**
* Reads and validates device_config_read_response from the Ultimo device.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param offset [in] Starting point in the packet buffer to read this message
* @param num_packets [in] Pointer to the expected number of device config packets
* @return AUD_SUCCESS if the DDP device config read ack was successfully read, else a non AUD_SUCCESS value is returned
*/
aud_error_t 
ddp_read_device_config_read_response
(
	const ddp_packet_read_info_t * packet_info,
	uint16_t offset,
...
/**
* Creates a DDP device config write request message. 
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param request_id [in] A non-zero sequence number which is populated in this message
* @return AUD_SUCCESS if the DDP device config write request message was successfully created, else a non AUD_SUCCESS value is returned
*/
aud_error_t 
...
/**
* Reads and validates device_config_write_response from the Ultimo device.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param offset [in] Starting point in the packet buffer to read this message
* @return AUD_SUCCESS if the DDP device config write ack was successfully read, else a non AUD_SUCCESS value is returned
*/
aud_error_t 
ddp_read_device_config_write_response
(
	const ddp_packet_read_info_t * packet_info,
	uint16_t offset
);
...
/**
* Creates a DDP device config packet ack.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param request_id [in] A non-zero sequence number which is populated in this message
* @param seq_num [in] A sequence number of the device config data packet to ack/nack
* @return AUD_SUCCESS if the DDP device config ack was successfully created, else a non AUD_SUCCESS value is returned
*/
aud_error_t
...
/**
* Creates a DDP device config packet nack.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param request_id [in] A non-zero sequence number which is populated in this message
* @param seq_num [in] A sequence number of the device config data packet to ack/nack
* @return AUD_SUCCESS if the DDP device config nack was successfully created, else a non AUD_SUCCESS value is returned
*/
aud_error_t
...
/**
* Reads and validates device_config_pkt_ack from the Ultimo device.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param offset [in] Starting point in the packet buffer to read this message
* @param seq_num [in] Pointer to the sequence number
* @return AUD_SUCCESS if the DDP device config packet ack was successfully read, else a non AUD_SUCCESS value is returned
*/
aud_error_t
ddp_read_device_config_pkt_ack
(
	const ddp_packet_read_info_t * packet_info,
	uint16_t offset,
	uint32_t * seq_num
...
/**
* Reads and validates device_config_pkt_nack from the Ultimo device.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param offset [in] Starting point in the packet buffer to read this message
* @param seq_num [in] Pointer to the sequence number
* @return AUD_SUCCESS if the DDP device config packet nack was successfully read, else a non AUD_SUCCESS value is returned
*/
aud_error_t
ddp_read_device_config_pkt_nack
(
	const ddp_packet_read_info_t * packet_info,
	uint16_t offset,
	uint32_t * seq_num
...
/**
* Creates a DDP device config end backup.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param request_id [in] A non-zero sequence number which is populated in this message
* @param flag [in] Flag with restore operation complete status
* @return AUD_SUCCESS if the DDP device config end backup message was successfully created, else a non AUD_SUCCESS value is returned
*/
aud_error_t
...
/**
* Reads and validates device_config_end_backup response from the Ultimo device.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param offset [in] Starting point in the packet buffer to read this message
* @return AUD_SUCCESS if the DDP device config end backup response was successfully read, else a non AUD_SUCCESS value is returned
*/
aud_error_t
ddp_read_device_config_end_backup_response
(
	const ddp_packet_read_info_t * packet_info,
	uint16_t offset
);
...
/**
* Creates a DDP device config end restore.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param request_id [in] A non-zero sequence number which is populated in this message
* @param flag [in] Flag with restore operation complete status
* @return AUD_SUCCESS if the DDP device config end restore message was successfully created, else a non AUD_SUCCESS value is returned
*/
aud_error_t
...
/**
* Reads and validates device_config_end_restore response from the Ultimo device.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param offset [in] Starting point in the packet buffer to read this message
* @return AUD_SUCCESS if the DDP device config end restore response was successfully read, else a non AUD_SUCCESS value is returned
*/
aud_error_t
ddp_read_device_config_end_restore_response
(
	const ddp_packet_read_info_t * packet_info,
	uint16_t offset
);
...
/**
* Creates a DDP set peer group ID request.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param request_id [in] A non-zero sequence number which is populated in this message
* @param valid_flags [in] Bitmap to indicate which fields are valid in the message. @see device_peer_group_id_valid_flags
* @param peer_group_id [in optional] Value of the peer group ID. The format is 16 byte UUID. To clear the peer group ID, set valid_flags appropriately
*  and pass in all zeros for the peer_group_id. If querying, then set this parameter to NULL
* @return AUD_SUCCESS if the DDP device config end restore message was successfully created, else a non AUD_SUCCESS value is returned
*/
aud_error_t
...
/**
* Reads and validates peer_group_id_response from the Ultimo device.
* @param packet_info [in] Pointer to a structure which has information about the DDP packet buffer
* @param offset [in] Starting point in the packet buffer to read this message
* @param peer_group_id [in] Pointer to the peer group ID
* @return AUD_SUCCESS if the DDP device peer group ID was successfully read, else a non AUD_SUCCESS value is returned
*/
aud_error_t
ddp_read_device_peer_group_id_response
(
	const ddp_packet_read_info_t * packet_info,
	uint16_t offset,
	ddp_dante_domain_uuid_t * peer_group_id
);
