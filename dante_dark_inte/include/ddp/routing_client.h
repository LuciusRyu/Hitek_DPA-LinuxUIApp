...
* @return AUD_SUCCESS if the DDP routing Rx flow configuration state response message was successfully read, else a non AUD_SUCCESS value is returned
* @deprecated Use \ref ddp_read_routing_rx_flow_config_state_response_flow_params_with_extension instead
*/
aud_error_t
...
* @return AUD_SUCCESS if the DDP routing Tx flow configuration state response message was successfully read, else a non AUD_SUCCESS value is returned
* @deprecated Use \ref ddp_read_routing_tx_flow_config_state_response_flow_params_with_extension instead
*/
aud_error_t
...
* @param out_status [out optional] Pointer to the status of the Rx channel @see ddp_routing_rx_flow_status indexed by flow_idx
...
(
	...
	ddp_request_id_t request_id,
	uint16_t num_chans,
	ddp_rx_chan_sub_params_t const * chan_subs
);
