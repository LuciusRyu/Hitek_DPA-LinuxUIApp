...
/**
* Type definition for Dante Domain UUID
*/
//! @cond Doxygen_Suppress
typedef uint8_t ddp_dante_domain_uuid_t[16];
...
enum device_general_capability_flags
{
	...
	CAPABILITY_FLAG_SUPPORT_DEVICE_CONFIG_BACKUP_RESTORE	= 0x00000400, /*!< Supports device configuration backup restore feature */
};
...
enum device_upgrade_error
{
	...
	DEVICE_UPGRADE_ERROR_IN_PROGRESS			= 0x030E,	/*!< error - */
...
/*
* @enum device_interop_action_flags
* @brief Interop flags to change the config of the device.
* These are modal flags. They are not present in device response.
*/

enum {
	DDP_INTEROP_FLAG__DISABLE_INTEROP = 1 << 0,		//Interop action flag to disable interop mode(s) and switch device to Dante-only mode.
};
...
enum device_dante_domain_response_valid_flags
{
	...
	DEVICE_DANTE_DOMAIN_RESPONSE_INDEX_DANTE_DOMAIN_NAME_VALID		= 0x00000004, /*!< The device dante domain response Dante domain name field is valid */
	DEVICE_DANTE_DOMAIN_RESPONSE_INDEX_DANTE_DOMAIN_UUID_VALID		= 0x00000008, /*!< The device dante domain response Dante domain UUID field is valid */
};
...
/**
* @enum device_peer_group_id_valid_flags
* @brief Bitmap which indicates which fields are valid in the ddp_device_peer_group_id_request message
*/
enum device_peer_group_id_valid_flags
{
	DEVICE_PEER_GROUP_ID_VALID			= 0x00000001,
};
...
struct ddp_device_general_response
{
	...
	struct
	{
		...
		dante_id64_t model_id;						/*!< 64-bit Dante model id of the device */
		ddp_raw_offset_t model_id_string_offset;	/*!< offset from the start of the payload to a NULL terminated Dante model id string */
...
struct ddp_device_aes67_request
{
	...
	struct
	{
		...
		uint16_t interop_action_flags_mask;	/*!< mask for interop action flags */
	} payload; /*!< fixed payload */
...
struct ddp_device_dante_domain_response
{
	...
	struct
	{
		...
		ddp_raw_offset_t dante_domain_name_offset;	/*!< offset to start of Dante Domain name string */
		ddp_raw_offset_t dante_domain_uuid_offset;	/*!< offset to start of Dante Domain UUID which is 16 bytes in length */
	} payload; /*!< fixed payload */
};
...
/**
* @struct ddp_device_config_rev_num_request
* @brief Structure format for the "device config revision number request" message
*/
struct ddp_device_config_rev_num_request
{
	ddp_message_header_t header;			/*!< message header */
...
/**
* @struct ddp_device_config_rev_num_response
* @brief Structure format for the "ddp_device_config_revision" message
*/
struct ddp_device_config_rev_num_response
{
	ddp_message_header_t header;			/*!< message header */
	...
	struct
	{
		uint32_t revision_num;			/*!< Revision number */
	} payload; /*!< fixed payload */
};

/**
* @struct ddp_device_config_read_request
* @brief Structure format for the "ddp_device_config_read_request" message
*/
struct ddp_device_config_read_request
{
	ddp_message_header_t header;			/*!< message header */
...
/**
* @struct ddp_device_config_read_response
* @brief Structure format for the "ddp_device_config_read_response" message
*/
struct ddp_device_config_read_response
{
	ddp_message_header_t header;			/*!< message header */
	...
	struct
	{
		uint16_t num_of_packets;			/*!< Number of packets of device config */
		uint16_t pad0;						/*!< Pad for alignment - must be '0' */
	} payload; /*!< fixed payload */
};

/**
* @struct ddp_device_config_write_request
* @brief Structure format for the "ddp_device_config_write_request" message
*/
struct ddp_device_config_write_request
{
	ddp_message_header_t header;			/*!< message header */
...
/**
* @struct ddp_device_config_write_response
* @brief Structure format for the "ddp_device_config_write_response" message
*/
struct ddp_device_config_write_response
{
	ddp_message_header_t header;			/*!< message header */
...
/**
* @struct ddp_device_config_end_backup_request
* @brief Structure format for the "ddp_device_config_end_backup_request" message
*/
struct ddp_device_config_end_backup_request
{
	ddp_message_header_t header;			/*!< message header */
	...
	struct
	{
		uint8_t flag;						/*!< Status of the restore process */
		uint8_t pad0;						/*!< Pad for alignment - must be '0' */
		uint16_t pad1;						/*!< Pad for alignment - must be '0' */
	} payload; /*!< fixed payload */
};
...
/**
* @struct ddp_device_config_end_restore_request
* @brief Structure format for the "ddp_device_config_end_restore_request" message
*/
struct ddp_device_config_end_restore_request
{
	ddp_message_header_t header;			/*!< message header */
...
/**
* @struct ddp_device_config_end_backup_response
* @brief Structure format for the "ddp_device_config_end_backup_response"
*/
struct ddp_device_config_end_backup_response
{
	ddp_message_header_t header;			/*!< message header */
...
/**
* @struct ddp_device_config_end_restore_response
* @brief Structure format for the "ddp_device_config_end_restore_response"
*/
struct ddp_device_config_end_restore_response
{
	ddp_message_header_t header;			/*!< message header */
...
/**
* @struct ddp_device_peer_group_id_request
* @brief Structure format for the "ddp_device_peer_group_id_request" message
*/
struct ddp_device_peer_group_id_request
{
	ddp_message_header_t header;				/*!< message header */
	...
	struct
	{
		uint32_t field_flags;					/*!< Bitmap of fields which are valid in the request @see device_peer_group_id_valid_flags */
		ddp_dante_domain_uuid_t peer_group_id;  /*!< Peer group ID to set on the device */
	} payload; /*!< fixed payload */
};

/**
* @struct ddp_device_peer_group_id_response
* @brief Structure format for the "ddp_device_peer_group_id_response" message
*/
struct ddp_device_peer_group_id_response
{
	ddp_message_header_t header;			/*!< message header */
	...
	struct
	{
		ddp_dante_domain_uuid_t  peer_group_id; /*!< Peer group ID set on the device which is a 16 byte UUID*/
	} payload; /*!< fixed payload */
};

/**
* @struct ddp_device_config_pkt_ack_nack
* @brief Structure format for the "ddp_device_config_pkt_ack_nack" message
*/
struct ddp_device_config_pkt_ack_nack
{
	ddp_message_header_t header;			/*!< message header */
	...
	struct
	{
		uint32_t sequence_number;			/*!< Sequence number of the ack/nack packet */
	} payload; /*!< fixed payload */
};
...
typedef struct ddp_device_config_rev_num_request ddp_device_config_rev_num_request_t;
typedef struct ddp_device_config_rev_num_response ddp_device_config_rev_num_response_t;
typedef struct ddp_device_config_read_request ddp_device_config_read_request_t;
typedef struct ddp_device_config_read_response ddp_device_config_read_response_t;
typedef struct ddp_device_config_write_request ddp_device_config_write_request_t;
typedef struct ddp_device_config_write_response ddp_device_config_write_response_t;
typedef struct ddp_device_config_end_backup_request ddp_device_config_end_backup_request_t;
typedef struct ddp_device_config_end_backup_response ddp_device_config_end_backup_response_t;
typedef struct ddp_device_config_end_restore_request ddp_device_config_end_restore_request_t;
typedef struct ddp_device_config_end_restore_response ddp_device_config_end_restore_response_t;
typedef struct ddp_device_config_pkt_ack_nack ddp_device_config_pkt_ack_nack_t;
typedef struct ddp_device_peer_group_id_request ddp_device_peer_group_id_request_t;
typedef struct ddp_device_peer_group_id_response ddp_device_peer_group_id_response_t;
//! @endcond
