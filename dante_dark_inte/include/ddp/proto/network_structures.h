...
struct ddp_network_intf_config
{
	...
	uint16_t mode;							/*!< Current configured mode of the interface @see network_intf_mode */
...
struct ddp_network_basic_control
{
	...
	uint16_t num_dns_domains;			/*!< Number of domain name strings include in the network basic response message */
};
...
/**
* @struct ddp_dns_domain_name_offsets
* @brief Structure format of an element of the array of offsets to DNS domain name strings for the "network basic response" message
*/
struct ddp_dns_domain_name_offsets
{
	ddp_raw_offset_t offset;	/*!< Offset from the start of the TLV0 header to the DNS domain name string */
};

//! @cond Doxygen_Suppress
typedef struct ddp_dns_domain_name_offsets ddp_dns_domain_name_offsets_t;
//! @endcond
...
struct ddp_network_basic_response
{
	...
	struct
	{
		...
		uint16_t num_dns_domains;					/*!< Number of DNS domain name string offset structures @see ddp_domain_name_offsets_t */
		ddp_raw_offset_t dns_domain_offset_array;	/*!< Offset from the start of the TLV0 header to the first DNS domain name string offset @see ddp_dns_domain_name_offsets_t */
...
struct ddp_network_config_request
{
	...
	struct
	{
		...
		ddp_raw_offset_t dns_domain_offset;		/*!< Offset from the start of the TLV0 header to the DNS domain name string, only valid if NETWORK_CONFIG_REQ_SET_STATIC_DOMAIN is set in the control_flags field */
...
struct ddp_network_config_response
{
	...
	struct
	{
		...
		ddp_raw_offset_t reboot_static_dns_domain_offset;	/*!< Static DNS domain string applied after a reboot, valid only if NETWORK_CONFIG_REBOOT_STATIC_DOMAIN_VALID is set in the valid flags field */
		uint16_t pad1;										/*!< Pad for alignment - must be '0' */
	} payload; /*!< fixed payload */
