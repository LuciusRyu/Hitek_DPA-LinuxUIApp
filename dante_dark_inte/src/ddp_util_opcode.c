...
const char * ddp_opcode_to_string(ddp_opcode_t opcode)
{
	...
	case DDP_OP_DEVICE_CONFIG_REVISION:				return "DEVICE_CONFIG_REVISION";
	case DDP_OP_DEVICE_READ_CONFIG:					return "DEVICE_READ_CONFIG";
	case DDP_OP_DEVICE_CONFIG_END_BACKUP:			return "DEVICE_CONFIG_END_BACKUP";
	case DDP_OP_DEVICE_WRITE_CONFIG:				return "DEVICE_WRITE_CONFIG";
	case DDP_OP_DEVICE_CONFIG_PKT_ACK:				return "DEVICE_CONFIG_PKT_ACK";
	case DDP_OP_DEVICE_CONFIG_PKT_NACK:				return "DEVICE_CONFIG_PKT_NACK";
	case DDP_OP_DEVICE_CONFIG_END_RESTORE:			return "DEVICE_CONFIG_END_RESTORE";
	case DDP_OP_DEVICE_PEER_GROUP_ID:				return "DEVICE_PEER_GROUP_ID";

	case DDP_OP_SWITCH_REG_ACCESS:					return "SWITCH_REGISTER_ACCESS";
	...
	case DDP_OP_CLOCK_V2_QUERY:						return "CLOCK_V2_QUERY";
	...
	case DDP_OP_ROUTING_RTP_RX_FLOW_CONFIG_SET:		return "ROUTING_RTP_RX_FLOW_CONFIG_SET";
	case DDP_OP_ROUTING_RTP_TX_FLOW_CONFIG_SET:		return "ROUTING_RTP_TX_FLOW_CONFIG_SET";
	...
	case DDP_OP_AUDIO_RTP_QUERY:					return "AUDIO_RTP_QUERY";
