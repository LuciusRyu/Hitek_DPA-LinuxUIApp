...
#include "../include/ddp/clocking_util.h"
...
const char * ddp_port_protocol_to_string(uint8_t protocol)
{
	switch (protocol) {
	case CLOCK_PROTOCOL_LAYER_3_PTP_VERSION_1: return "V1";
	case CLOCK_PROTOCOL_LAYER_3_PTP_VERSION_2: return "V2";
	}
	return "?";
}
